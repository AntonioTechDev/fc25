"""
Multi-Automation-System - GUI Logger
====================================
...
Descrizione:
GUI di monitoraggio log in tempo reale per il Multi-Automation-System.
...
class LogGUI:
    ...
    def create_gui(self):
        ...
        self.root = tk.Tk()
        self.root.title("🔍 Monitor Log - Multi-Automation-System")
    ...
    def setup_layout(self):
        ...
        # Titolo
        title_label = ttk.Label(main_frame, text="📊 Multi-Automation-System Log Monitor", 
                               font=("Arial", 12, "bold"))
