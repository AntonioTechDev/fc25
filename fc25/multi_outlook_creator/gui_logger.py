"""
gui_logger.py - GUI di monitoraggio log per l'automazione multi-account Outlook
"""
...
class LogGUI:
    ...
    def setup_layout(self):
        ...
        # Titolo
        title_label = ttk.Label(main_frame, text="📊 Log Monitor", font=("Arial", 12, "bold"))
