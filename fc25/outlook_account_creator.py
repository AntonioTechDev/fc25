...
# Template Paths con Testi da Inserire, Durata Click e Delay Custom opzionale
# Formato: (template_path, testo, durata_click_secondi, [custom_click_delay])
# custom_click_delay: opzionale, se >0 viene usato come pausa dopo quell'elemento
AUTOMATION_SEQUENCE = [
    ("./fc25/templates/email_input.png", "f359-fifa@outlook.com", 0),
    ...
    ("./fc25/templates/captcha_button.png", "", 13, 15),  # Esempio: click tenuto 13s, poi pausa 15s
